...
namespace TexDrawLib.Editor
{
    ...
    public class TEXPreferenceEditor : UnityEditor.Editor
    {
        ...
        private GUIContent hyphenationTexFileLabel = new GUIContent("Hyphenation Definition", "Visit https://hyphenation.org/ to download a hyphenation .tex file then place it here");
        ...
        private void DrawConfiguration()
        {
            ...
            targetPreference.spriteMaterial = (Material)EditorGUILayout.ObjectField("Sprite Material", targetPreference.spriteMaterial, typeof(Material), false);
            targetPreference.hyphenationTexFile = (TextAsset)EditorGUILayout.ObjectField(hyphenationTexFileLabel, targetPreference.hyphenationTexFile, typeof(TextAsset), false);
