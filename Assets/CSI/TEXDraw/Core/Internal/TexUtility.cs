...
namespace TexDrawLib.Core
{
    ...
    public static class TexUtility
    {
        ...
        public static Color32 MultiplyColor(Color32 a, Color b)
        {
            ...
            byte cr = (byte)Mathf.LerpUnclamped(a.r, b.r * 255, b.a);
            byte cg = (byte)Mathf.LerpUnclamped(a.g, b.g * 255, b.a);
            byte cb = (byte)Mathf.LerpUnclamped(a.b, b.b * 255, b.a);
            return new Color32(cr, cg, cb, a.a);
        }
